...
public class AmdCpu(string line, string socket, int coresNumber, int streamsNumber, double frequency, string? graphicsCore)
    : ICpu
{
    public int Id { get; set; }
    public string Producer { get; set; } = "AMD";
    ...
    public string? GraphicsCore { get; set; } = graphicsCore == string.Empty ? "None" : graphicsCore;
}